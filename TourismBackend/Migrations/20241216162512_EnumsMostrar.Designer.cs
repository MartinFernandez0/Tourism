...
namespace TourismBackend.Migrations
{
    ...
    [Migration("20241216162512_EnumsMostrar")]
    partial class EnumsMostrar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourismServices.Models.pfClient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2024, 12, 16, 13, 25, 5, 392, DateTimeKind.Local).AddTicks(4964),
                            ReservationStatus = 0,
                            TotalAmount = 150000.00m,
                            TransactionDate = new DateTime(2024, 12, 16, 13, 25, 5, 392, DateTimeKind.Local).AddTicks(4991)
                        });
                });
