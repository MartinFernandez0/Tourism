...
namespace TourismBackend.Migrations
{
    ...
    [Migration("20241212041624_AcceptNullDestinationId")]
    partial class AcceptNullDestinationId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourismServices.Models.pfClient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostalCode = "12345",
                            ReservationDate = new DateTime(2024, 12, 12, 1, 16, 23, 509, DateTimeKind.Local).AddTicks(6343),
                            ReservationStatus = 0,
                            TotalAmount = 150000.00m,
                            TransactionDate = new DateTime(2024, 12, 12, 1, 16, 23, 509, DateTimeKind.Local).AddTicks(6358)
                        });
                });
